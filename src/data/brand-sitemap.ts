...
const defaultImages: BrandSitemapImage[] = [
	{
		...
		title: 'grounded cheats esp',
		caption: 'grounded cheats esp god mode',
	},
	{
		src: '/images/grounded-cheats-wallhack.webp',
		title: 'grounded cheats god mode',
		caption: 'grounded cheats god mode trainer',
	},
	{
		src: '/images/grounded-cheats-aimbot.webp',
		title: 'grounded cheats trainer',
		caption: 'grounded cheats free crafting mod menu',
	},
	{
		src: '/images/grounded-cheats-aimbot-view.webp',
		title: 'grounded cheats mod menu',
		caption: 'grounded cheats trainer view',
	},
	{
		src: '/images/grounded-cheats-radar.webp',
		title: 'grounded cheats item spawner',
		caption: 'grounded cheats free crafting',
	},
	{
		src: '/images/grounded-cheats-raid.webp',
		title: 'grounded cheats',
		caption: 'grounded cheats in backyard survival',
	},
];
...
const pageImageTemplates: Record<PageId, { title: string; caption: string }> = {
	home: { title: '{brand} hero — ESP and trainer in Grounded', caption: 'Homepage preview of {primaryKeyword} on Windows PC' },
	'grounded-god-mode': { title: '{primaryKeyword} ESP overlay', caption: 'Player ESP boxes and distance with {primaryKeyword}' },
	'grounded-trainer': { title: '{primaryKeyword} trainer view', caption: 'Trainer and trainer controls controls in {primaryKeyword}' },
	features: { title: '{primaryKeyword} features', caption: 'ESP, trainer controls, and radar included with {primaryKeyword}' },
	...
	wallhack: { title: '{primaryKeyword} cheat engine', caption: 'God mode visibility with {primaryKeyword}' },
	radar: { title: '{primaryKeyword} radar', caption: 'item spawner map cues in {primaryKeyword}' },
	'anti-cheat': { title: '{antiCheat} and {primaryKeyword}', caption: '{primaryKeyword} rebuilds after an Easy Anti-Cheat update' },
	'cheats-2026': { title: '{primaryKeyword} overview', caption: '{primaryKeyword} for Grounded on PC' },
	hacks: { title: '{primaryKeyword}', caption: '{primaryKeyword} ESP, trainer, and radar package' },
	...
	'soft-aim': { title: '{primaryKeyword} trainer controls', caption: 'Trainer controls settings in {primaryKeyword}' },
	'best-cheats': { title: 'Best {primaryKeyword}', caption: 'Why players pick {primaryKeyword}' },
	'aimbot-hack': { title: '{primaryKeyword} trainer', caption: 'Trainer tools in {primaryKeyword}' },
