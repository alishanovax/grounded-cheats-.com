...
const sourcePath =
	'C:/Users/Aman/.cursor/projects/c-Users-Aman-groundedhacks/assets/c__Users_Aman_AppData_Roaming_Cursor_User_workspaceStorage_5fc01ad59007d6b1ec3564ba48b04eb7_images_image-4be7ee07-5934-4878-8eb6-1fb2f3143ab4.png';
...
async function generateSiteLogo() {
	...
	console.log('Wrote public/images/grounded-cheats-logo.png (512×512)');
	...
	console.log('Wrote public/images/grounded-cheats-logo.webp');
}
...
async function generateWebManifest() {
	const manifest = {
		...
		short_name: 'Grounded Cheats',
		description: 'Undetected grounded cheats — ESP, trainer, radar and for PC',
		start_url: '/',
		display: 'standalone',
