#!/usr/bin/env node
/**
 * Ports the 8 posts from ../grounded-blog into src/data/blog/posts.generated.ts
 * and rewrites scripts/generate-grounded-blog-posts.mjs sources for future regenerations.
 */
...
const SOURCE_DIR = join(ROOT, '..', 'grounded-blog', 'src', 'content', 'posts');
...
const IMAGE_KEYS = {
	...
	'hammer-ar-s-tier-data-analysis': 'trainerCombat',
...
for (const file of POST_FILES) {
	...
	sources.push({
		...
		intro: post.excerpt,
		keywords: [...post.tags, 'grounded intel'],
...
const file = `/* Auto-generated by scripts/port-from-grounded-blog.mjs — do not edit by hand. */
